...
public class Updat3r {
    ...
    public void sendUpdateMessage(Player p) {
        p.sendMessage("   §3-=-=-=[§bDiscordLinker§3]=-=-=-   ");
        p.sendMessage("§3Er is een update beschikbaar voor §bDiscordLinker§3!");
        ...
        p.sendMessage("§3Om deze update te installeren, type §b/dclinker update.");
        p.sendMessage("   §3-=-=-=[§bDiscordLinker§3]=-=-=-   ");
    }
